...
let menu = [
    {
        ...
        link: "./assets/pages/services/home_cleaning.html",
    },
    {
        ...
        link: "./assets/pages/services/move_cleaning.html",
    },
    {
        ...
        link: "./assets/pages/services/deep_cleaning.html",
    }
];
        ...
        <div class="col">
            <div class="card" style="width: 21rem;">
              ...
              <div class="card-body">
                ...
                <a href=${item.link} class="btn btn-card"><i class="bi bi-plus-circle"></i>More</a>
              </div>
            </div>
          </div>`;
    });
